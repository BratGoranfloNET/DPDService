(function ($, admin) {
	...
	var options = {
		formId: '#locationsForm',
		contactsSelector: 'select[name=ContactId]',
		upload: {
			actionUrl: '/locations/image/upload',
			blobIdSelector: '#imageBlobIdLocation',
			blobNameSelector: '#imageBlobNameLocation',
			triggerSelector: '.upload-image-location',
			fileInputSelector: '#imageFileInputLocation',
			blobThumbPreviewSelector: '#thumbPreviewLocation',
			statusLabelSelector: '.uploading-status-location',
