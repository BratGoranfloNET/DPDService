...
{	
	public class EventTypeFormViewModelValidator : AbstractValidator<EventTypeViewModel>
	{
		private IBlobsRepository _blobsRepository = null;

		public EventTypeFormViewModelValidator(IBlobsRepository blobsRepository)
		{
