...
namespace BG.Web.UI.Models
{
	...
	/// </summary>
	public class ArticlePaginationViewModel<ArticleViewModel> :  BaseViewModel, IEnumerable<ArticleViewModel>, IPagination
    {

        private IEnumerable<ArticleViewModel> _collection;
        ...
        public ArticlePaginationViewModel(IEnumerable<ArticleViewModel> collection, int startIndex, int requestedCount, int totalCount)
        {
        ...
        /// </returns>
        public IEnumerator<ArticleViewModel> GetEnumerator()
        {
