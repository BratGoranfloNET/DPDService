...
namespace BG.Web.UI.Bundles
{
	...
	/// Specialized bundle.
	/// </summary>
	public class LocationsIndexStyles : StyleBundle
	{
		/// <summary>
		/// Gets the path that will reference this bundle on views.
		/// </summary>
		public const string BundleVirtualPath = "~/bundles/locations/index-styles";

		/// <summary>
		/// Constructor method.
		/// </summary>
		public LocationsIndexStyles() : base(BundleVirtualPath)
		{
