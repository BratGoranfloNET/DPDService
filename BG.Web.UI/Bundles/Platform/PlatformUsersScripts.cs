...
namespace BG.Web.UI.Bundles
{
	...
	/// Specialized bundle.
	/// </summary>
	public class PlatformUsersScripts : ScriptBundle
	{
		/// <summary>
		/// Gets the path that will reference this bundle on views.
		/// </summary>
		public const string BundleVirtualPath = "~/bundles/platform/users-scripts";

		/// <summary>
		/// Constructor method.
		/// </summary>
		public PlatformUsersScripts() : base(BundleVirtualPath)
		{
			// Data tables
