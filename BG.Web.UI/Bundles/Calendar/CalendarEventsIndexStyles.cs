...
namespace BG.Web.UI.Bundles
{
	...
	/// Specialized bundle.
	/// </summary>
	public class CalendarEventsIndexStyles : StyleBundle
	{
		/// <summary>
		/// Gets the path that will reference this bundle on views.
		/// </summary>
		public const string BundleVirtualPath = "~/bundles/calendar/events-styles";

		/// <summary>
		/// Constructor method.
		/// </summary>
		public CalendarEventsIndexStyles() : base(BundleVirtualPath)
		{
