...
namespace BG.Web.UI.Bundles
{
	...
	/// Specialized bundle.
	/// </summary>
	public class CalendarEventsIndexScripts : ScriptBundle
	{
		/// <summary>
		/// Gets the path that will reference this bundle on views.
		/// </summary>
		public const string BundleVirtualPath = "~/bundles/calendar/events-scripts";

		/// <summary>
		/// Constructor method.
		/// </summary>
		public CalendarEventsIndexScripts() : base(BundleVirtualPath)
		{
			// Data tables
